...
$$ -\log{} $$를 취하였기 때문에, 0과 1 사이로 표현되는 확률은 0에 가까워질수록 지수적으로 높은 정보량을 가짐을 알 수 있습니다. 언어모델에 이를 적용시켜 보면, 흔히 나올 수 없는 문장(확률이 낮은 문장)일수록 더 높은 정보량을 가질 것이라고 생각 할 수 있습니다.
...
위의 식은 기본 Cross Entropy 수식입니다. 이것을 우리의 모델($$ \theta $$)에 적용하여 보면 아래와 같습니다.
