...
우항을 해석해보면, $$ w_1 $$가 나타날 확률과 $$ w_1 $$가 주어졌을 때 $$ w_2 $$가 나타날 확률, $$ w_1, w_2 $$가 주어졌을 때 $$ w_3 $$가 주어졌을 확률, $$ w_1, w_2, w_3 $$가 주어졌을 때 $$ w_4 $$가 나타날 확률을 곱하는 것을 알 수 있습니다. 이로써 우리는 language model을 통해서 문장에 대한 확률 뿐만 아니라, 단어와 단어 사이의 확률도 정의 할 수 있습니다. 좀 더 실제 예제를 가지고 표현 해 보도록 하겠습니다.
