...
time gs -q -dNOPAUSE -dBATCH -sDEVICE=docxwrite -sOutputFile=./docx/merged.docx ./docx/0.preface.docx ./docx/1.introduction.docx ./docx/2.basic-math.docx ./docx/3.pytorch-intro.docx ./docx/4.preprocessing.docx ./docx/5.word-senses.docx ./docx/6.word-embedding.docx ./docx/7.sequential-modeling.docx ./docx/8.text-classification.docx ./docx/9.language-modeling.docx ./docx/10.nmt.docx ./docx/11.adv-nmt.docx ./docx/12.rl.docx ./docx/13.duality.docx ./docx/14.productization.docx ./docx/15.transfer_learning.docx ./docx/16.epilogue.docx
