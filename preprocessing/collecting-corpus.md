...
Machine Translation을 위한 parallel corpus를 구하는 것은 monolingual corpus에 비해서 상당히 어렵습니다. Crawling을 수행 할 때에는 해당 사이트의 robots.txt를 확인하여 적법한 절차를 통해 crawling을 수행하길 권장 합니다.
